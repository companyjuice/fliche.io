<?php
    ...
    class AnimatedGifTranscoderGifsicle extends AnimatedGifTranscoderAbstract
    {
         ...
         * @access public
         * @author Oliver Lillie
         * @param  Fliche\Config $config The PHPVideoToolit\Config object.
         */
...
//          tidy up any converted image to gifs.
         ...
         * @access public
         * @author Oliver Lillie
         * @param  Fliche\Image $image The image source that you wish to add as a frame to the gif.
         * @return Fliche\AnimatedGifTranscoderGifsicle Returns the current object.
         */
...
//          if it is not a gif.
         ...
         * @throws Fliche\AnimatedGifException If imagemagick convert is user but encounters an error.
         * @throws \RuntimeException If PHP GD is used and imagegif is not available on the current system.
         * @throws Fliche\AnimatedGifException If the image given to convert is not supported by PHP GD.
         * @throws Fliche\AnimatedGifException If the image fails to convert to a gif using PHP GD.
         * @throws Fliche\AnimatedGifException If the image fails to convert.
         * @throws Fliche\AnimatedGifException If the image fails to convert but a path was generated.
         * @throws Fliche\AnimatedGifException If the image fails to convert but a file was generated by 0 bytes in size.
         */
