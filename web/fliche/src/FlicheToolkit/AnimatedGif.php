<?php
    ...
    class AnimatedGif
    {
         ...
         * @param  FlicheToolkit\Config $config The FlicheToolkit\Config object
...
//          auto detect a transcoder based on order of preference.
            ...
            if($this->_config->gif_transcoder === null)
            {
                ...
                {
                    $transcoder_class = '\\FlicheToolkit\\AnimatedGifTranscoder'.ucfirst($transcoder);
...
//              create the transcoder and check it's available
                $transcoder_class = '\\FlicheToolkit\\AnimatedGifTranscoder'.ucfirst($this->_config->gif_transcoder);
         ...
         * @static
         * @author Oliver Lillie
         * @param  array $image_object_array An array of FlicheToolkit\Image objects to use to create the animated gif.
         ...
         * @param  FlicheToolkit\Config $config The FlicheToolkit\Config object.
         * @return FlicheToolkit\AnimatedGif Returns a FlicheToolkit\AnimatedGif object.
         ...
         * @throws \InvalidArgumentException If any of the values within $image_object_array is not an instance of FlicheToolkit\Image.
         */
...
//          create a new gif and add all the frames.
            ...
            {
                if(is_object($image) === false || get_class($image) !== 'FlicheToolkit\\Image')
                {
                    throw new \InvalidArgumentException('The image at key '.$key.' is not an \\FlicheToolkit\\Image object. Each frame must be an Image object.');
                }
...
//          set the loop count
        ...
        {
            trigger_error('FlicheToolkit\Animatedgif::expand() has not yet been implemented.', E_USER_NOTICE);
        }
    }
