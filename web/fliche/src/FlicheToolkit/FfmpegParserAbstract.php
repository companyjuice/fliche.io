<?php
    ...
    abstract class FfmpegParserAbstract extends Parser
    {
         ...
         *  then the data is re-read from ffmpeg.
         * @return string Returns the raw buffer data from ffmpeg.
         * @throws FlicheToolkit\FfmpegProcessException If the call to ffmpeg encounters an error.
         */
...
//          then match out the relevant data, clean and process.
         ...
         * @throws FlicheToolkit\FfmpegProcessException If a version is not found in the basic information then we call ffmpeg -version
...
//          if both version and build are not available throw a new exception to get the user to provide their ffmpeg data to github so we can start building up different formats of ffmpeg output.
            ...
            {
                throw new FfmpegProcessException('Unable to determine your FFmpeg version or build. Please create an issue at the github repository for FlicheToolkit 2; https://github.com/buggedcom/phpvideotoolkit-v2/issues. Please add the following data to the ticket:<br />
<br />              
