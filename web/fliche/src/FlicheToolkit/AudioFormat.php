<?php
    ...
    class AudioFormat extends Format
    {
        ...
        /**
         * This is a hook function that is called when the FlicheToolkit\Media::_processOutputFormat function is run.
         ...
         *  following constants:
         *  FlicheToolkit\Media::OVERWRITE_FAIL
         *  FlicheToolkit\Media::OVERWRITE_EXISTING
         *  FlicheToolkit\Media::OVERWRITE_UNIQUE
         * @return FlicheToolkit\AudioFormat Returns the current object.
         ...
         * FlicheToolkit\FfmpegParser::getCodecs or 'copy'. There are a few audio codecs that are automagically 
...
//              fix acc
            ...
            if(in_array($audio_codec, $codecs) === false)
            {
                throw new \InvalidArgumentException('Unrecognised audio codec "'.$audio_codec.'" set in \\FlicheToolkit\\'.get_class($this).'::setAudioCodec');
            }
...
//          now check the class settings to see if restricted pixel formats have been set and have to be obeyed
            if($this->_restricted_audio_codecs !== null)
            {
                ...
                {
                    throw new \InvalidArgumentException('The audio codec "'.$audio_codec.'" cannot be set in \\FlicheToolkit\\'.get_class($this).'::setAudioCodec. Please select one of the following codecs: '.implode(', ', $this->_restricted_audio_codecs));
                }
            }
...
//          now check the class settings to see if restricted audio bitrates have been set and have to be obeys
            if($this->_restricted_audio_bitrates !== null)
            {
                ...
                {
                    throw new \InvalidArgumentException('The bitrate "'.$bitrate.'" cannot be set in \\FlicheToolkit\\'.get_class($this).'::setAudioBitrate. Please select one of the following bitrates: '.implode(', ', $this->_restricted_audio_bitrates));
                }
            }
        ...
        public function setAudioSampleFrequency($audio_sample_frequency)
        {
            ...
            {
                throw new \InvalidArgumentException('Unrecognised audio sample frequency "'.$format.'" set in \\FlicheToolkit\\'.get_class($this).'::setAudioSampleFrequency');
            }
...
//          now check the class settings to see if restricted audio audio sample frequencies have been set and have to be obeyed
            if($this->_restricted_audio_sample_frequencies !== null)
            {
                ...
                {
                    throw new \InvalidArgumentException('The audio sample frequency "'.$audio_sample_frequency.'" cannot be set in \\FlicheToolkit\\'.get_class($this).'::setAudioSampleFrequency. Please select one of the following sample frequencies: '.implode(', ', $this->_restricted_audio_sample_frequencies));
                }
            }
        ...
        public function setAudioChannels($channels)
        {
            ...
            {
                throw new \InvalidArgumentException('Unrecognised audio channels "'.$channels.'" set in \\FlicheToolkit\\'.get_class($this).'::setAudioChannels. The channels value must be one of the following values: 0, 1, 2, or 6.');
            }
        ...
        public function setVolume($volume)
        {
            ...
            {
                throw new \InvalidArgumentException('Unrecognised volume value "'.$volume.'" set in \\FlicheToolkit\\'.get_class($this).'::setVolume. The value must be higher than or equal to 0.');
            }
...
//          interpret quality into ffmpeg value
            ...
            {
                throw new \InvalidArgumentException('Unrecognised quality "'.$quality.'" set in \\FlicheToolkit\\'.get_class($this).'::setAudioQuality. The quality value must be between 0 and 100.');
            }
