<?php
    ...
    class AnimatedGifTranscoderPhp extends AnimatedGifTranscoderAbstract
    {
         ...
         * @throws FlicheToolkit\AnimatedGifException If an empty gif is generated.
         * @throws FlicheToolkit\AnimatedGifException If the gif couldn't be saved to the filesystem.
         */
