<?php
    ...
    abstract class AnimatedGifTranscoderAbstract
    {
        ...
        /**
         * A variable holder to contain the FlicheToolkit\Image frames.
         * @var array
         * @access protected
         */
        protected $_frames;
         ...
         * @access public
         * @author Oliver Lillie
         * @param FlicheToolkit\Image $image A FlicheToolkit\Image object to add to the animated gif frames array.
        ...
        public function setOverwriteMode($mode)
        {
            ...
            {
                throw new \InvalidArgumentException('The $mode argument must be one of the following values: FlicheToolkit\Media::OVERWRITE_FAIL, FlicheToolkit\Media::OVERWRITE_EXISTING, FlicheToolkit\Media::OVERWRITE_UNIQUE');
            }
       ...
       /**
         ...
         * @throws \RuntimeException If $overwrite is set to FlicheToolkit::Media::OVERWRITE_FAIL and the $save_path already exists.
         * @throws \RuntimeException If $overwrite is set to FlicheToolkit::Media::OVERWRITE_EXISTING and the $save_path is not writable.
         */
