<?php
    ...
    class FfmpegProcess extends ProcessBuilder
    {
         ...
         * @access protected
         * @var FlicheToolkit\ProgressHandlerAbstract
         */
...
//          if we have an error and we want to delete any output on the error
        ...
        public function getPortableId()
        {
            ...
            if(isset($trace[1]) === false || $trace[1]['function'] !== 'getPortableId' || $trace[1]['class'] !== 'FlicheToolkit\Media')
            {
