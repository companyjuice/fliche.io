<?php
    ...
    /**
     * The very lowest base class in FlicheToolkit. It is the exec() wrapper than can determine if a call to exec fails or completes successfully.
    ...
    class ExecBuffer
    {
         ...
         * @return FlicheToolkit\ExecBuffer Returns the current object.
