<?php
    ...
    class FfmpegProcessProgressable extends FfmpegProcess 
    {
         ...
         * @return FlicheToolkit\FfmpegProcess Returns the current object.
         * @throws FlicheToolkit\FfmpegProcessCommandUnavailableException If the timelimit command is not available on the configured ffmpeg.
         ...
         * @access public
         * @author Oliver Lillie
         * @param mixed $callback Can be a callable callback, or an object that extends FlicheToolkit\ProgressHandlerAbstract
         * @return FlicheToolkit\FfmpegProcess Returns the current object.
         * @throws \InvalidArgumentException If the callback is an object and is not a subclass of FlicheToolkit\ProgressHandlerAbstract
        ...
        public function attachProgressHandler($callback)
        {
            ...
            {
                if(is_subclass_of($callback, 'FlicheToolkit\ProgressHandlerAbstract') === false)
                {
...
//          get the output of the process
         ...
         * If a single video or audio is being outputted then the related FlicheToolkit media object
         ...
         * @throws FlicheToolkit\FfmpegProcessOutputException If the function is called but the process has not completed
         *  yet.
         * @throws FlicheToolkit\FfmpegProcessOutputException If the process was aborted.
         * @throws FlicheToolkit\FfmpegProcessOutputException If the process completed with a termination signal.
         * @throws FlicheToolkit\FfmpegProcessOutputException If the process completed with an error.
         * @throws FlicheToolkit\FfmpegProcessOutputException If returned output is empty.
         * @throws FlicheToolkit\FfmpegProcessOutputException If returned output files does not exist.
         * @throws FlicheToolkit\FfmpegProcessOutputException If returned output files does exist but is a 0 byte file.
         */
...
//              we have the output path but we now need to treat differently dependant on if we have multiple file output.
         ...
         * @return object Either "Media", "Video", "Audio" or "Image" FlicheToolkit objects.
         */
...
//                      if the start timecode has not been generated then find the required from the path string.
         ...
         * @return string Returns the class name of the FlicheToolkit class related to the given $path argument.
         */
...
//          now we have the information switch between the types and create the return object.
            ...
            switch($type)
            {
                ...
                case 'video' :
                case 'image' :
                    $class = '\\FlicheToolkit\\'.ucfirst(strtolower($type));
                    break;
            }
