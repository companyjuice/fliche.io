<?php
    ...
    /**
     * A configuration object to store all the configuration values required for FlicheToolkit.
    ...
    class Config
    {
         ...
         * supplied in the constructor to all the FlicheToolkit objects.
         *
         * @access public
         * @author Oliver Lillie
         * @return void
         ...
         * @param array $options
         * @access private
         * @return FlicheToolkit\Config Returns the current object
         */
         ...
         *
         * @param string $name
         * @throws FlicheToolkit\ConfigSetException Thrown if any of the values for the related config settings is invalid.
         */
        public function __set($key, $value)
        {
            switch($key)
            {
                ...
                case 'cache_driver' :
                    ...
                    $class = '\FlicheToolkit\Cache_'.$value;
                    if(class_exists($class) === false)
                    {
                        throw new ConfigSetException('Unrecognised cache driver engine. The cache class must be within the FlicheToolkit namespace and be prefixed by `Cache_`.');
                    }
                    if(is_subclass_of($class, '\FlicheToolkit\CacheAbstract') === false)
                    {
                        throw new ConfigSetException('Unrecognised cache driver engine. The cache driver provider must inherit from \FlicheToolkit\CacheAbstract.');
                    }
