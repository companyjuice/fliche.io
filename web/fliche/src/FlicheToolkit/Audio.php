<?php
    ...
    /**
     * This class extends FlicheToolkit\Media. If provides some additional required commands if the input
     * is an audio file.
     *
    ...
    class Audio extends Media
    {
         ...
         * @param  FlicheToolkit\AudioFormant $audio_input_format The input format object to use, if any. Otherwise null
...
//          validate this media file is an audio file
         ...
         * @access public
         * @author Oliver Lillie
         * @param  FlicheToolkit\Format $output_format The output format being used to save the output media.
         ...
         * @param  FlicheToolkit\ProgressHandlerAbstract $progress_handler The progress handler attached to the save, if any. 
         * @return void
         */
