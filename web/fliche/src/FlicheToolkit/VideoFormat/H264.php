<?php
    ...
    class VideoFormat_H264 extends VideoFormat
    {
        ...
        public function setH264Preset($preset=null)
        {
            ...
            {
                throw new \InvalidArgumentException('Unrecognised h264 preset "'.$preset.'" set in \\FlicheToolkit\\'.get_class($this).'::setH264Preset');
            }
        ...
        public function setH264Tune($tune=null)
        {
            ...
            {
                throw new \InvalidArgumentException('Unrecognised h264 tune "'.$preset.'" set in \\FlicheToolkit\\'.get_class($this).'::setH264Tune');
            }
        ...
        public function setH264Profile($profile=null)
        {
            ...
            {
                throw new Exception('Unrecognised h264 profile "'.$profile.'" set in \\FlicheToolkit\\'.get_class($this).'::setH264Profile');
            }
