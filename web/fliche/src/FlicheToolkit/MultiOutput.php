<?php
    ...
    class MultiOutput implements \IteratorAggregate
    {
         ...
         * @param  Config $config The FlicheToolkit configuration options.
         */
        ...
        public function addOutput($output_path, Format $output_format=null)
        {
            ...
            {
                throw new \LogicException('Output for `'.$output_path.'` has already been given. Unable to set new output. If you wish to remove output please call FlicheToolkit\Ouput->removeOutput($output_path);.');
            }
