...
<head>
    ...
    <meta charset="utf-8">
    <title>FlicheToolkit Documentation</title>
            ...
            <div class="span3">
                <div class="well sidebar-nav">
                    <ul class="nav nav-list">
                        ...
                        <li<?php echo $current_page === 'documentation.what-fliche-is-not.php' ? ' class="active"' : ''; ?>><a href="./documentation.what-fliche-is-not.php">What Fliche is NOT</a></li>
