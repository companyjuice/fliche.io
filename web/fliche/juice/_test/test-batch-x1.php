...
/*
echo '<pre>';
echo '# get list of files in $v_batch_dir'; echo "\n";
echo '# foreach( $v_batch_files as $v_file ){ '; echo "\n";
echo '#   : 0) $v_file: "";'; echo "\n";
echo '#   : 1) get file metadata'; echo "\n";
echo '#   : 2) add record to database'; echo "\n";
echo '#   : 3) run ffmpeg functions'; echo "\n";
echo '#   : 4) upload new files to cloud'; echo "\n";
echo '#   : 5) save records to database'; echo "\n";
echo '# } ';
echo '</pre>';
*/
...
function run_batch() {
  ...
  #$v_batch_dir = 'G:\bkp\media\fishflicks';
  $v_batch_dir = '/var/www/html/assets/videogallery';
  $v_batch_files = array();
  $v_file = '';
