...
require_once 'vzaar/src/Vzaar.php';
require_once 'vzaar/src/User.php';
require_once 'vzaar/src/Video.php';
require_once 'vzaar/src/VideoList.php';
require_once 'vzaar/src/AccountType.php';
...
Vzaar::uploadVideo("media/video.mp4");
