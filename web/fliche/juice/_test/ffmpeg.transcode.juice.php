...
$dest_file  = __ROOT__.'/assets/videogallery/47_thumb1043870064.ff.mkv';
...
#exec("$ffmpeg_exe -y -i $src_file $dest_file 2>&1 &", $output);
#var_dump($output);
//?? -loglevel panic OR -nostats
$last_line = system("$ffmpeg_exe -nostats -y -i $src_file $dest_file 2>&1 &", $output);
#var_dump($last_line);
#var_dump( $output );
 ...
 */
$ffmpeg_duration = getVideoDuration( $ffmpeg_exe, $dest_file );
