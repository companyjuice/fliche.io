<?php
    ...
    try
    {
        ...
        $process = $video->saveNonBlocking($example_video_path . '.mov', null, Media::OVERWRITE_EXISTING, $progress_handler);
        ...
        $format->setVideoDimensions(160, 90);

        $progress_handler = new ProgressHandlerNative();
        $process = $mov->saveNonBlocking($example_video_path . '.resized.mov', $format, Media::OVERWRITE_EXISTING, $progress_handler);
        ...
        $process = $resized_mov->save($example_video_path . '.resized.jpg', $format, Media::OVERWRITE_EXISTING);
