...
try
{
  ...
  $process = $video->extractSegment(new Timecode('00:00:05.00'), new Timecode('00:00:15.00'))
                   ->extractFrames(null, null, '1/30')
                   ->save('./output/extract-frames.05-15.juice.%timecode.jpg', null, Media::OVERWRITE_EXISTING);
