...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="#">Fliche Video Toolkit</a>
            <div class="nav-collapse collapse">
                <p class="navbar-text pull-right">
                    <a href="https://github.com/companyjuice/fliche-v2">GitHub Repository</a>
                </p>
                <ul class="nav">
                    <li<?php echo $current_page === 'index.php' ? ' class="active"' : ''; ?>><a href="./index.php">Home</a></li>
                    <li<?php echo strpos($current_page, 'documentation.') === 0 ? ' class="active"' : ''; ?>><a href="./documentation.what-fliche-is-not.php">Documentation</a></li>
        ...
        <div class="span3">
            <div class="well sidebar-nav">
                <ul class="nav nav-list">
                    ...
                    <li<?php echo $current_page === 'documentation.what-fliche-is-not.php' ? ' class="active"' : ''; ?>><a href="./documentation.what-fliche-is-not.php">What is Fliche?</a></li>
                    ...
                    <li<?php echo $current_page === 'documentation.fliche-class-reference.php' ? ' class="active"' : ''; ?>><a href="./documentation.fliche-class-reference.php">Fliche Class Reference</a></li>
                    <li class="divider"></li>
...
?>
        ...
        <div class="span9">
            <div class="alert alert-error">
                <strong><?php echo $example_video_path; ?> does not exist</strong> 
                <p>In order for the supplied examples to work, you need to download the file to the <?php echo BASE; ?>juice/media directory.</p>
            </div>
        </div>
