...
try
{
  ...
  $process = $video->extractSegment(new Timecode('00:00:00.00'), new Timecode('00:00:30.00'))
                   ->extractFrames(null, null, '1/100')
                   ->save($example_video_path . '.xframe.%timecode.jpg', null, Media::OVERWRITE_EXISTING);
