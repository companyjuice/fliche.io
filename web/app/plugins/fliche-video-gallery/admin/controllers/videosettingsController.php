      ...
      public function get_message() { 
          ...
          switch ($this->_update) {
            case '1':
              ...
              $this->_msg = __ ( 'Settings Updated  Successfully ...', FLICHE_VGALLERY );
              break;
            case '0':
              /** Set settings update is unsuccess message */
              $this->_msg = __ ( 'Settings Not Updated  Successfully ...', FLICHE_VGALLERY );
              break;
            default:
              $this->_msg = '';
              break;
...
if ($adminPage == 'hdflvvideosharesettings') {
    require_once (FLICHE_VGALLERY_BASEDIR . DS . 'admin/views/videosetting.php');
}
?>