  ...
  class AjaxPlaylistController extends AjaxPlaylistModel { 
        ...
        public function hd_ajax_add_playlist( $name, $media) {
            ...
            if (count ( $planame1 ) > 0) {
                ...
                render_error ( __ ( 'Failed, category name already exist', FLICHE_VGALLERY ) ) . $this->get_playlist_for_dbx ( $media );
                return;
            }            
            ...
            if (! empty ( $p_name )) {   
                ...
                if ($insert_plist != 0) {
                    ...
                    $this->render_message ( __ ( 'Category', FLICHE_VGALLERY ) . ' ' . $name . ' ' . __ ( 'added successfully', FLICHE_VGALLERY ) ) . $this->get_playlist_for_dbx ( $media );
                }
            }
