...
if ( ! wp_verify_nonce( $nonce, 'upload-video' ) ) {
    ...
    $errormsg [0] = '<b>' . __ ('Upload Success', FLICHE_VGALLERY) .':</b>' . __('File Uploaded Successfully', FLICHE_VGALLERY);
    $errormsg [1] = '<b>' . __ ('Upload Cancelled', FLICHE_VGALLERY) .':</b>' . __('Cancelled by user', FLICHE_VGALLERY);
    $errormsg [2] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('Invalid File type specified', FLICHE_VGALLERY);
    $errormsg [3] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('Your File Exceeds Server Limit size', FLICHE_VGALLERY);
    $errormsg [4] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('Unknown Error Occured', FLICHE_VGALLERY);
    $errormsg [5] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('The uploaded file exceeds the upload_max_filesize directive in php.ini', FLICHE_VGALLERY);
    $errormsg [6] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('The uploaded file exceeds the MAX_FILE_SIZE directive specified in the HTML form', FLICHE_VGALLERY);
    $errormsg [7] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('The uploaded file was only partially uploaded', FLICHE_VGALLERY);
    $errormsg [8] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('No file was uploaded', FLICHE_VGALLERY);
    $errormsg [9] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('Missing a temporary folder', FLICHE_VGALLERY);
    $errormsg [10] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('Failed to write file to disk', FLICHE_VGALLERY);
    $errormsg [11] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('File upload stopped by extension', FLICHE_VGALLERY);
    $errormsg [12] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('Unknown upload error', FLICHE_VGALLERY);
    $errormsg [13] = '<b>' . __ ('Upload Failed', FLICHE_VGALLERY) .':</b>' . __('Please check post_max_size in php.ini settings', FLICHE_VGALLERY);
    ...
    function doupload($file) {
      ...
      /**
       * Check the uploaded file is: srt (subtitle files), image, or video. 
       * Rename the original file name, based on the MAX( vid ) + 1 query.
       */
      switch ( $extension ) {
        case 'srt':
