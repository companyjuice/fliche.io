	...
	if($user_role == 'administrator') {
      ...
      <?php /** Display page title and icon in all videos page starts */ ?>
          ...
          <?php
            ...
            <form class="admin_video_action" name="videofrm" id="videofrm" action="" method="post" onsubmit="return VideodeleteIds()"> 
                ...
                <div class="alignleft actions" style="margin-bottom: 10px;"> 
                    <select name="videoactionup" id="videoactionup"> 
                        <option value="-1" selected="selected"><?php esc_attr_e('Bulk Actions', FLICHE_VGALLERY ); ?></option>
                        <option value="videodelete"><?php esc_attr_e('Delete', FLICHE_VGALLERY ); ?></option>
                        <option value="videopublish"><?php esc_attr_e('Publish',FLICHE_VGALLERY); ?></option>
                        <option value="videounpublish"><?php esc_attr_e('Unpublish',FLICHE_VGALLERY); ?></option>
                        <option value="videofeatured"><?php esc_attr_e('Add to Featured',FLICHE_VGALLERY); ?></option>
                        <option value="videounfeatured"><?php esc_attr_e('Remove from Feature',FLICHE_VGALLERY); ?></option>
                    </select> 
                    <input type="submit" name="videoapply" class="button-secondary action" value="<?php esc_attr_e( 'Apply', FLICHE_VGALLERY ); ?> "> 
                </div> 
            ...
            <?php /** Display header section in videos page starts */ ?>
                <thead> 
                    ...
                    <tr> 
                        <th width="1%" scope="col" class="manage-column column-cb check-column">
                        ...
                        */ ?>
                        ...
                        <th width="5%" scope="col" class="manage-column column-id sortable desc">
                          <a href="<?php echo $videoIDURL; ?>"><span>
                          <?php esc_attr_e( 'ID', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th>

                        <th width="90" scope="col" class="manage-column column-image">
                          <span><?php esc_attr_e( 'Thumb', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span>
                        </th>

                    <?php if ($user_role != 'subscriber') { ?>
                        <th width="22%" scope="col" class="manage-column column-name sortable desc">
                          <a href="<?php echo $videoTitleURL ; ?>"><span>
                          <?php esc_attr_e( 'Title', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th>
                        <th width="8%" scope="col" class="manage-column column-name sortable desc">
                          <a href="<?php echo $videoTitleURL ; ?>"><span>
                          <?php esc_attr_e( 'Link', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th> 
                    <?php } else { ?>
                        <th width="30%" scope="col" class="manage-column column-name sortable desc">
                          <a href="<?php echo $videoTitleURL ; ?>"><span>
                          <?php esc_attr_e( 'Title', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th> 
                    <?php } ?>
                        ...
                        <th width="15%" scope="col" class="manage-column column-author sortable desc">
                          <a href="<?php echo $videoAuthorURL; ?>"><span>
                          <?php esc_attr_e( 'Author', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th>

                        <th width="15%" scope="col" class="manage-column column-playlistname sortable desc">
                          <a href="<?php echo $videoCatURL ; ?>"><span>
                          <?php esc_attr_e( 'Categories', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th>

                        <th width="12%" scope="col" class="manage-column column-createddate sortable desc">
                          <a href="<?php echo $videoDateURL; ?>"><span>
                          <?php esc_attr_e( 'Date', 'digi' ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th> 

                        <?php /*
                        <th width="4%" scope="col" class="manage-column column-ordering sortable desc">
                          <a href="<?php echo $videoOrderURL; ?>"> 
                          <span><?php esc_attr_e( 'Sort', FLICHE_VGALLERY ); ?></span><span class="sorting-indicator"></span> 
                        </a></th> 
                        */ ?>

                        <th width="8%" scope="col" class="manage-column column-feature sortable desc text_center" nowrap="nowrap">
                          <a href="<?php echo $videoFeaURL; ?>"><span>   
                          <?php esc_attr_e( 'Feature', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th> 

                        <th width="8%" scope="col" class="manage-column column-publish sortable desc text_center" nowrap="nowrap">
                          <a href="<?php echo $videoStatusURL; ?>"><span>
                          <?php esc_attr_e( 'Publish', FLICHE_VGALLERY ); ?></span>
                          <span class="sorting-indicator"></span></a>
                        </th>
                    </tr>
                </thead>
            ...
            <?php  /** Looping through video details for videos page */
                ...
                foreach ( $gridVideo as $videoView ) {
                    ...
                    <td class="column-id"> <?php if ( $user_role != 'subscriber' ) { ?> <span class="hasTip content" 
                        title="<?php esc_attr_e( 'Click and Drag', FLICHE_VGALLERY ); ?>" style="padding: 6px;"> 
                    ...
                    */ ?>
                    ...
                    <td class="image column-image"> 
                        ...
                        href="<?php echo $videoidURL ; ?>">
                        <img width="90" height="60" src="<?php echo $thumb_image; ?>" class="attachment-80x60" alt="THUMB"> </a> 
                    </td> 
                    ...
                    */ ?>
                    ...
                    <?php 
                        ...
                        if ( $feaStatus == 0 ) { 
                            $a_title = 'Remove from Featured';
                        } else { 
                            $a_title = 'Add to Featured';
                        }
                    ?>
                        
                        <a title="<?php echo $a_title; ?>" href="<?php echo $feaURL; ?>">
                    ...
                    <td class="description column-publish column-publish" style="text-align: center"><?php $status = 1; 
                        ...
                        if ( $status == 0 ) { 
                            $a_title = 'Click to Unpublish';
                        } else { 
                            $a_title = 'Click to Publish';
                        }

                        if (($user_role != 'subscriber') || ($player_colors ['member_publish_enable']==1 )) { ?>
                          
                          <a title="<?php echo $a_title; ?>" href="<?php echo $statURL; ?>">
                          <img src="<?php echo getImagesDirURL() . $image ?>" /></a>
                            ...
                            <a title="<?php echo $a_title; ?>" href="<?php echo $statURL; ?>">
                          <?php } else { ?>
                            <a title="<?php echo $a_title; ?>" href="#" onclick="return alert('Publish option was disabled by admin')">
                          <?php } ?>">
                    ...
                    if (count ( $gridVideo ) == 0) { ?>
                        <tr class="no-items"> <td class="colspanchange" colspan="5"><?php esc_attr_e( 'No videos found.', FLICHE_VGALLERY ); ?></td> </tr> 
                    <?php } ?> 
        ...
        if ( 1 == 0 ) { ?>
                ...
                <?php /** Display footer title in all videos page */ ?>
                <tfoot> 
                <?php /** Display footer section video checkbox column */ ?>  
                <tr> <th scope="col" class="manage-column column-cb check-column"><input type="checkbox" name="" id="manage-column-video-1"></th> 
                <?php /** Display footer section video drag and drop column */ ?>
                <th scope="col" class="manage-column column-ordering"> <span> <?php esc_attr_e( '', FLICHE_VGALLERY ); ?> </span><span class="sorting-indicator"></span> </th> 
                <?php /** Display footer section video id column */ ?>
                <th scope="col" class="manage-column column-id sortable desc"><a href="<?php echo $videoIDURL; ?>"> 
                    <span> <?php esc_attr_e( 'ID', FLICHE_VGALLERY ); ?> </span><span class="sorting-indicator"></span></a></th> 
                <?php /** Display footer section video title column */ ?>
                <th scope="col" class="manage-column column-image"><span class="sorting-indicator"></span></th>
            <?php if ($user_role != 'subscriber') { ?>
                <th scope="col" class="manage-column column-name sortable desc"><a href="<?php echo $videoTitleURL; ?>"> 
                ...
                <?php /** Display footer section video author column */ ?>
                 <th scope="col" class="manage-column column-name sortable desc"><a href="<?php echo $videoTitleURL ; ?>"> 
                    <span> <?php esc_attr_e( 'Videolink', FLICHE_VGALLERY ); ?> </span><span class="sorting-indicator"></span></a></th> 
            <?php } else { ?>
               	<th scope="col" class="manage-column column-name sortable desc"><a href="<?php echo $videoTitleURL; ?>"> 
                    <span> <?php esc_attr_e( 'Title', FLICHE_VGALLERY ); ?> </span><span class="sorting-indicator"></span></a></th> 
                <?php /** Display footer section video author column */ ?>
            <?php   } ?>
                ...
                <?php /** Display footer section video author column */ ?>
                <th scope="col" class="manage-column column-author sortable desc"><a href="<?php echo $videoAuthorURL; ?>"> 
                    <span> <?php esc_attr_e( 'Author', FLICHE_VGALLERY ); ?></span><span class="sorting-indicator"></span></a></th> 
                <?php /** Display footer section video category column */ ?>
                <th scope="col" class="manage-column column-playlistname sortable desc"> <a href="<?php echo $videoCatURL; ?>"> 
                    <span> <?php esc_attr_e( 'Categories', FLICHE_VGALLERY ); ?></span><span class="sorting-indicator"></span></a> </th> 
                <?php /** Display footer section video featured column */ ?>
                <th scope="col" class="manage-column column-feature sortable desc text_center"><a href="<?php echo $videoFeaURL; ?>"> 
                    <span> <?php esc_attr_e( 'Featured', FLICHE_VGALLERY ); ?></span><span class="sorting-indicator"></span></a></th> 
                <?php /** Display footer section video date column */ ?>
                <th scope="col" class="manage-column column-createddate sortable desc"><a href="<?php echo $videoDateURL; ?>"> 
                    <span><?php esc_attr_e( 'Date', 'digi' ); ?></span><span class="sorting-indicator"></span></a></th> 
                <?php /** Display footer section video publish column */ ?>
                <th scope="col" class="text_center manage-column column-publish sortable desc"><a href="<?php echo $videoStatusURL; ?>"> 
                    <span> <?php esc_attr_e( 'Publish', FLICHE_VGALLERY ); ?></span><span class="sorting-indicator"></span></a></th> 
                <?php /** Display footer section video ordering column 
                <th scope="col" class="manage-column column-ordering sortable desc"><a href="<?php echo $videoOrderURL; ?>"> 
          ...
          <div class="alignleft actions" style="margin-top: 10px;"> 
              <select name="videoactiondown" id="videoactiondown"> 
                  ...
                  <option value="videounpublish"><?php esc_attr_e('Unpublish',FLICHE_VGALLERY); ?></option>
                  <option value="videofeatured"><?php esc_attr_e('Add to Featured',FLICHE_VGALLERY); ?></option>
                  <option value="videounfeatured"><?php esc_attr_e('Remove from Featured',FLICHE_VGALLERY); ?></option>
              </select> 
              <input type="submit" name="videoapply" class="button-secondary action" value="<?php esc_attr_e( 'Apply', FLICHE_VGALLERY ); ?>"> 
          </div>
          ...
          <?php if ( 1 == 1 && $user_role != 'subscriber') { ?>
          ...
          <div class="show-hide-intro-shortcode">
              ...
              <?php /** Display how to use information starts */ ?>
                  ...
                  <div class="portlet-content admin_short_video_info">
                      ...
                      This shortcode will have the following parameters. </p>
                ...
                <div class="portlet"> 
                    ...
                    <div class="portlet-content admin_short_video_info"> <?php esc_attr_e('Mentioned below are the appropriate URLs to get RSS Feeds for:',FLICHE_VGALLERY);?><br> <br> 
                        <?php esc_attr_e('Popular Videos',FLICHE_VGALLERY); ?> - 
                        <strong><?php esc_attr_e(get_site_url().'/wp-admin/admin-ajax.php?action=rss&task=popular',FLICHE_VGALLERY);?></strong><br> <br> 
                        <?php esc_attr_e('Featured Videos',FLICHE_VGALLERY); ?> - 
                        <strong><?php esc_attr_e(get_site_url().'/wp-admin/admin-ajax.php?action=rss&task=featured',FLICHE_VGALLERY);?></strong><br> <br> 
                        <?php esc_attr_e('Recent Videos',FLICHE_VGALLERY); ?> - 
                        <strong><?php esc_attr_e(get_site_url().'/wp-admin/admin-ajax.php?action=rss&task=recent',FLICHE_VGALLERY);?></strong><br> <br> 
                        <?php esc_attr_e('Any particular playlist',FLICHE_VGALLERY);?> - 
                        <strong><?php esc_attr_e(get_site_url().'/wp-admin/admin-ajax.php?action=rss&task=category&playid=1',FLICHE_VGALLERY);?></strong><br>
                        <?php esc_attr_e('( Here replace the URL with your Playlist ID )', FLICHE_VGALLERY);?><br> <br> 
                        <?php esc_attr_e('Any particular video',FLICHE_VGALLERY);?> - 
                        <strong><?php esc_attr_e(get_site_url().'/wp-admin/admin-ajax.php?action=rss&task=video&vid=1',FLICHE_VGALLERY);?></strong><br>
                         <?php esc_attr_e('( Here replace the URL with your Video ID )', FLICHE_VGALLERY);?><br> <br>
                    </div>
                </div> 
            </div>
            <?php */ 
