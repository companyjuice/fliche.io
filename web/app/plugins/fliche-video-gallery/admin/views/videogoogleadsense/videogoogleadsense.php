...
<?php /** Call function to display admin tabs in playlist page */
    ...
    <div class="wrap"> 
        <h2 class="option_title"> <?php echo '<img src="' . getImagesDirURL() .'google_adsense.png" alt="move" width="30"/>'; ?> 
            <?php esc_attr_e( 'Google AdSense', FLICHE_VGALLERY ); ?> 
              ...
              <?php /** Display head title section starts */ ?> 
                  <thead> 
                      <tr>
                          ...
                          <th scope="col"  style="" class="manage-column column-id sortable desc">
                              ...
                              <span><?php esc_attr_e( 'ID', FLICHE_VGALLERY ); ?>
                  ...
                  <tfoot> 
                      <tr> 
                          ...
                          <th scope="col" class="manage-column column-id sortable desc" style="">
                              ...
                              <span><?php esc_attr_e( 'ID', FLICHE_VGALLERY ); ?></span> <span class="sorting-indicator"></span> </a>
                          </th>
                          <?php /** Display footer adsense title section */ ?>
                          <th scope="col" class="manage-column column-name sortable desc"><a> <span><?php esc_attr_e( 'Title', FLICHE_VGALLERY ); ?></span> </a> </th>
                          ...
                          <th scope="col" class="manage-column column-publish sortable desc" style="">
                              ...
                              <span><?php esc_attr_e( 'Publish', FLICHE_VGALLERY ); ?></span> <span class="sorting-indicator"></span> </a>
                          </th> 
                      </tr> 
                  </tfoot>
               ...
               <?php /** Looping google adsense details to display in grid section */
                      ...
                      <tr class="no-items"> 
                          ...
                          <td class="colspanchange" colspan="3"><?php esc_attr_e('No Google AdSense Found.' , FLICHE_VGALLERY );?></td> 
                      </tr> 
                      <?php } ?> 
                  </tbody> 
              </table>
