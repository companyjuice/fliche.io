            ...
            <div class="column"> 
              <input type='hidden' name="license" value="IL8SYLXRL-JFGIFIREKPEJTIPCONTUS" />
                ...
                <?php esc_attr_e( 'License Configuration', FLICHE_VGALLERY ); ?></b> </div> 
                             ...
                             <?php /** Display filed to get license *?> 
                                ...
                                <td valign="top"> <input type='text' name="license" value="<?php echo $settingsGrid->license ; ?>"  style="float: left;" size="45" /> 
                                    <?php if ( 1 == 0 && isset( $settingsGrid->license ) && ( !strpos( $settingsGrid->license ,'CONTUS' ) ) ) { ?>
                                        <?php echo '<a class="buynow-btn" target="_blank" href="http://companyjuice.com/start/fliche"><img valign="top" src="' . getImagesDirURL(). 'buynow.gif" alt="Buy"/></a>'; 
                                    } ?>
                                </td>
                            </tr>
                        </table>
                 ...
                 */
                 ?>
                <?php echo $portletDiv; ?> 
                <b> <?php esc_attr_e( 'Logo Configuration', FLICHE_VGALLERY ); ?></b> </div> 
                        <?php echo $portletContentDiv. $gallerySeparatorDiv; ?> 
                        <?php /** Display filed to get logo path  */?> 
                                    <th scope='row'><?php esc_attr_e( 'Logo Path', FLICHE_VGALLERY ); ?></th> 
                                ...
                                <?php /** Display filed to get logo target */?> 
                                    <th scope='row'><?php esc_attr_e( 'Logo Target', FLICHE_VGALLERY ); ?></th> 
                   ...
                   <?php echo $portletDiv; ?> 
                   <b><?php esc_attr_e( 'Player Configuration', FLICHE_VGALLERY ); ?></b></div> 
                                   <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>  
                                   <?php /** Display Auto Play */ ?><th scope='row'>
                                   <?php esc_attr_e( 'Auto Play', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?><th scope='row'>
                                   <?php esc_attr_e( 'Social Icon', FLICHE_VGALLERY ); ?></th><td><input type='checkbox' 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?> <th scope='row'>
                                   <?php esc_attr_e( 'Posted By', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php /** Display related video */  echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Show related video', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php esc_attr_e( 'Show Added On', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?> <th scope='row'>
                                   <?php esc_attr_e( 'Show Rss Feed Icon', FLICHE_VGALLERY ); ?></th> <td>
                       ...
                       <?php echo $portletDiv; ?>
                       <b><?php esc_attr_e( 'General Settings', FLICHE_VGALLERY ); ?></b></div> 
                                   <?php /** Disaplay ffmpeg path */  ?>
                                   <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'FFMPEG Path', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Embed Visible', FLICHE_VGALLERY ); ?></th> 
                                       <td><input type='checkbox' class='check' <?php if ( $settingsGrid->embed_visible == 1 ) { ?> checked <?php } ?> name="embed_visible" value="1" size=45  /></td> 
                                   </tr> 
                                   <?php /** Iframe visible  */ ?> 
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Iframe Visible', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Enable Report', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?> 
                                       <th scope='row'><?php esc_attr_e( 'Enable Views', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Enable Ratings', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Enable Tags', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?> 
                                       <th scope='row'><?php esc_attr_e( 'Enable Category', FLICHE_VGALLERY ); ?></th>
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Enable video title in Home page', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Show Description', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Display Default Image', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?> 
                                       <th scope='row'>
                                       <?php esc_attr_e( 'Subtitle Text Color', FLICHE_VGALLERY ); ?></th>
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Subtitle Background Color', FLICHE_VGALLERY ); ?></th> 
                                       <td> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Subtitle Font Family', FLICHE_VGALLERY ); ?></th> 
                                   ...
                                   <?php echo $gallerySeparatorDiv; ?>  
                                       <th scope='row'><?php esc_attr_e( 'Subtitle Font Size', FLICHE_VGALLERY ); ?></th> 
                       ...
                       <?php echo $portletDiv; ?>
                       <?php esc_attr_e( 'Player Color Settings', FLICHE_VGALLERY ); ?> 
                          <?php esc_attr_e( 'Ex : 0xdddddd ', FLICHE_VGALLERY ) ?></b></div> 
                                  <?php /** Share Popup Header color */ ?>
                                      <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>  
                                          <th scope='row'> <?php esc_attr_e( 'Share Popup Header Color', FLICHE_VGALLERY ); ?> </th>
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'> 
                                          <?php esc_attr_e( 'Share Popup Background Color', FLICHE_VGALLERY ); ?> 
                                          </th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?> <th scope='row'>
                                      <?php esc_attr_e( 'Share Popup Text Color', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Progress Bar Background Color', FLICHE_VGALLERY ); ?></th> 
                                          <td><input size=45 type='text' name="pro_BgColor" value="<?php echo $player_colors['pro_BgColor']; ?>"   /> </td> 
                                      </tr> 
                                      <?php /** Play Button Color */ ?> 
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Play Button Color', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Play Button Background Color', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Player Buttons Color', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Player Buttons Background Color', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <tr class="gallery_separator" id="related_bgColor" style="display:none;"> <th scope='row'><?php esc_attr_e( 'Related Videos Background Color', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Related Videos Scroll Bar Color */ ?> <tr class="gallery_separator" id="related_scroll_barColor" style="display:none;"> 
                                          <th scope='row'><?php esc_attr_e( 'Related Videos Scroll Bar Color', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <tr class="gallery_separator" id="related_scroll_barbgColor" style="display:none;"> 
                                          <th scope='row'><?php esc_attr_e( 'Related Videos Scroll Bar Background Color', FLICHE_VGALLERY ); ?></th> <td><input type='text' name="scroll_BgColor" 
                      ...
                      <div class="column">
                          <?php echo $portletDiv; ?>
                          <?php esc_attr_e( 'Playlist Configuration', FLICHE_VGALLERY ); ?></b></div>
                                      <?php /** Select Playlist*/ ?>
                                      <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Playlist', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <tr class="gallery_separator" id="related_playlist_open" style="display:none;"> 
                                          <th scope='row'><?php esc_attr_e( 'Playlist Open', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'HD Default', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Playlist Autoplay', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php echo $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Related Video View', FLICHE_VGALLERY ); ?></th> 
                          ...
                          <?php echo $portletDiv; ?> 
                              <b><?php esc_attr_e( 'Ads Settings', FLICHE_VGALLERY ); ?></b></div> 
                                      <?php /** Preroll */ ?> 
                                      <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>
                                      <?php /** Display filed to enable / disable preroll ads */?>   
                                          <th scope='row'><?php esc_attr_e( 'Preroll Ads', FLICHE_VGALLERY ); ?></th> 
                                          <td> <input name="preroll" id="preroll" type='radio' value="0"  <?php if ( $settingsGrid->preroll == 0 ) { 
                                                  echo 'checked'; 
                                                } ?> /> <label><?php esc_attr_e( 'Enable', FLICHE_VGALLERY ); ?></label> 
                                                <input name="preroll" id="preroll" type='radio' value="1"  <?php if ( $settingsGrid->preroll == 1 ) { 
                                                  echo 'checked'; 
                                                } ?> /> <label><?php esc_attr_e( 'Disable', FLICHE_VGALLERY ); ?></label>
                                          </td> 
                                      </tr> 
                                      <?php /** Postroll */ ?> 
                                      <?php echo $gallerySeparatorDiv; ?>  
                                      <?php /** Display filed to enable / disable postroll ads */?>
                                          <th scope='row'><?php esc_attr_e( 'Postroll Ads', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to enable / disable midroll ads */?>  
                                          <th scope='row'><?php esc_attr_e( 'Midroll Ads', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to enable / disable ima ads */?>
                                          <th scope='row'><?php esc_attr_e( 'IMA Ads', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to enable / disable google adsense */?>
                                          <th scope='row'><?php esc_attr_e( 'Google Ads', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to enable / disable ads skip */?>
                                          <th scope='row'><?php esc_attr_e( 'Ad Skip', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to get ads skip duration */?> 
                                          <th scope='row'><?php esc_attr_e( 'Ad Skip Duration', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to get track code */?>
                                          <th scope='row'><?php esc_attr_e( 'Track Code', FLICHE_VGALLERY ); ?></th> 
                          ...
                          <?php echo $portletDiv; ?> 
                              <b><?php esc_attr_e( 'Comment Settings', FLICHE_VGALLERY ); ?></b></div> 
                                      <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>  
                                          <th scope='row'><?php esc_attr_e( 'Select Comment Type', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to get FB API to add videos  */?>
                                          <th scope='row'><?php esc_attr_e( 'App ID', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <?php /** Display filed to get disqus name */?>
                                          <th scope='row'><?php esc_attr_e( 'Shot Name', FLICHE_VGALLERY ); ?></th> 
                                      ...
                                      <tr class="gallery_separator" id="facebook_api_link"  ><th> <a href="http://developers.facebook.com/" target="_blank"><?php esc_attr_e( 'Create Facebook App ID', FLICHE_VGALLERY ); ?></a></th></tr> 
                                  </table>
                              </div> 
                          </div> 
                          ...
                          <?php echo $portletDiv; ?> 
                          <b><?php esc_attr_e( 'Skin Configuration', FLICHE_VGALLERY ); ?></b></div> 
                              <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>  
                              <?php /** Display filed to enable / disable timer */?>
                                  <th scope='row'><?php esc_attr_e( 'Display Timer', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <?php /** Display filed to enable / disable zoom */?>
                                  <th scope='row'><?php esc_attr_e( 'Display Zoom', FLICHE_VGALLERY ); ?> </th> 
                              ...
                              <?php /** Display filed to enable / disable email */?>
                                  <th scope='row'><?php esc_attr_e( 'Display Email', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php /** Display filed to enable / disable share */?>
                                  <th scope='row'><?php esc_attr_e( 'Display Share', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <?php /** Display filed to enable / disable volume */?>
                                  <th scope='row'><?php esc_attr_e( 'Display Volume', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php /** Display filed to enable / disable progress bar */?>
                                  <th scope='row'><?php esc_attr_e( 'Display Progress Bar', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php /** Display filed to enable / disable full screen */?>
                                  <th scope='row'><?php esc_attr_e( 'Display Full Screen', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php /** Display filed to enable / disable skin autohide */?>
                                  <th scope='row'><?php esc_attr_e( 'Skin Autohide', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php /** Display filed to enable / disable skin visible  */?>
                                  <th scope='row'><?php esc_attr_e( 'Skin Visible', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php /** Display filed to enable / disable skin opacity */?>
                                  <th scope='row'><?php esc_attr_e( 'Skin Opacity', FLICHE_VGALLERY ); ?></th>
                  ...
                  <?php echo $portletDiv; ?>
                      <b><?php esc_attr_e( 'Videos Page Settings', FLICHE_VGALLERY ); ?></b></div>
                              <?php /** Display Gutter Space */ ?>
                              <?php echo $portletContentDiv . $gallerySeparatorDiv; ?>  
                              <th> <?php /** Display filed to get gutter space */?>
                              <?php esc_attr_e( 'Gutter Space ( px )', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php esc_attr_e( 'Limit Related Videos count', FLICHE_VGALLERY ); ?></th> <td>
                              ...
                              <?php echo $gallerySeparatorDiv; ?> <th>
                              <?php esc_attr_e( 'No Of Categories in Home page', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <?php echo $gallerySeparatorDiv; ?> 
                                  <th><?php esc_attr_e('Videos Order', FLICHE_VGALLERY ); ?></th>
                                  <td> <select name="recent_video_order" class="recent_video_order_setting"> 
                                        <option value="id" <?php if($player_colors['recentvideo_order'] =='id'){ 
                                          echo "selected='selected'";
                                        } ?>> <?php echo esc_attr('Recent',FLICHE_VGALLERY); ?> </option> 
                                        <option value="hitcount" <?php if($player_colors['recentvideo_order'] =='hitcount'){ 
                                          echo "selected='selected'";
                                        } ?>> <?php echo esc_attr('Most viewed',FLICHE_VGALLERY); ?> </option>
                                        <option value="default" <?php if($player_colors['recentvideo_order'] =='default'){ 
                                          echo "selected='selected'";
                                        } ?>> <?php echo esc_attr('Default ( Ordering)',FLICHE_VGALLERY); ?> </option> 
                                        </select>
                                        <div><?php echo esc_attr('Only Applicable for Featured and  Category Videos',FLICHE_VGALLERY);?></div> 
                                  </td> 
                              </tr> 
                              <?php /** Enable / disbale Popular Videos */ ?>
                              <?php echo $gallerySeparatorDiv; ?> 
                              <th><?php esc_attr_e( 'Popular Videos', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <label><?php esc_attr_e( 'Rows', FLICHE_VGALLERY ); ?></label>
                                  <input id="rowsPop" name="rowsPop" size="10" type="text"   value="<?php echo $settingsGrid->rowsPop ; ?>"></td>
                                  <td><label><?php esc_attr_e( 'Columns', FLICHE_VGALLERY ); ?> </label>
                              ...
                              <th><?php esc_attr_e( 'Recent Videos', FLICHE_VGALLERY ); ?></th>
                              <td> <input type='radio' name="recent"  value="1" <?php if ( $settingsGrid->recent == 1 ) { 
                                    ...
                                    echo 'checked'; 
                                    } ?> /> <label><?php esc_attr_e( 'Disable', FLICHE_VGALLERY ); ?></label> </td>
                              </tr>
                              <?php /** Rows , columns for Recent Videos */ ?>
                              <tr class="gallery_separator_row"> <td><label><?php esc_attr_e( 'Rows', FLICHE_VGALLERY ); ?></label>
                              ...
                              <?php /** Featured Videos  */ ?>
                              <?php echo $gallerySeparatorDiv; ?> 
                                  <th><?php esc_attr_e( 'Featured Videos', FLICHE_VGALLERY ); ?></th>
                              ...
                              <tr class="gallery_separator_row">
                                  <td><label><?php esc_attr_e( 'Rows', FLICHE_VGALLERY ); ?></label>
                              ...
                              <?php echo $gallerySeparatorDiv; ?> 
                                  <th><?php esc_attr_e( 'Category Videos', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php echo $gallerySeparatorDiv; ?>
                              <th><?php esc_attr_e( 'More Page', FLICHE_VGALLERY ); ?></th>  </tr>
                              <tr class="gallery_separator_row">
                                  <td><label><?php esc_attr_e( 'Rows', FLICHE_VGALLERY ); ?></label>
                  ...
                  <?php echo $portletDiv; ?> 
                      <b><?php esc_attr_e( 'Amazon S3 Bucket Setting', FLICHE_VGALLERY ); ?></b></div> 
                              <?php echo $portletContentDiv . $gallerySeparatorDiv; ?> 
                                  <?php /** Enable / disbale Amazon S3 Bucket settings Starts */ ?>
                                  <th><?php esc_attr_e( 'Store Videos in Amazon S3 Bucket', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php echo $gallerySeparatorDiv; ?>  
                                  <th><?php esc_attr_e( 'Enter Amazon S3 Bucket name', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <?php echo $gallerySeparatorDiv; ?>  
                                  <th><?php esc_attr_e( 'Enter Amazon S3 Bucket link', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <?php echo $gallerySeparatorDiv; ?>  
                                  <th><?php esc_attr_e( 'Enter Amazon S3 Bucket Access Key', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <?php echo $gallerySeparatorDiv; ?> 
                                  <th><?php esc_attr_e( 'Enter Amazon S3 Bucket Access Secret Key', FLICHE_VGALLERY ); ?></th> 
                  ...
                  <?php echo $portletDiv; ?> 
                      <b> <?php esc_attr_e( 'User Video Setting', FLICHE_VGALLERY ); ?> </b></div> 
                              <?php /** Display Youtube API Key */ ?>
                              <?php echo $portletContentDiv . $gallerySeparatorDiv; ?> 
                                  <th><?php esc_attr_e( 'Enter Youtube API Key', FLICHE_VGALLERY ); ?></th>
                              ...
                              <?php echo $gallerySeparatorDiv; ?>  
                                  <th> <?php esc_attr_e( 'Video Upload Option to Members', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <?php echo $gallerySeparatorDiv; ?>  
                                  <th> <?php esc_attr_e( 'Video Publish Option for Members', FLICHE_VGALLERY ); ?></th> 
                              ...
                              <tr class="gallery_separator" > 
                                  <th> <?php esc_attr_e( 'Select upload method(s) for users', FLICHE_VGALLERY ); ?> </th> 
                                  <td> <?php echo esc_attr_e('( Press ctrl button and Choose Multiple Option)',FLICHE_VGALLERY);?>
                                       ...
                                       <?php $allowed_method = explode(',',$player_colors['user_allowed_method']); ?> 
                                        <span> <select name="user_allowed_method[]" size="5" multiple="multiple" >
                                         ...
                                         <?php /** Show Upload file is selected */ ?>
                                            ...
                                            <?php esc_attr_e( 'Embed Video', FLICHE_VGALLERY ); ?></option>
                                            <?php }  ?>
                                        </select>
                                  </span>
                                  </td>
                  ...
                  <div class="bottom_btn">
                      <input class='button-primary' id='videogallery_setting' style="float:right; " name="updatebutton"  type='submit' value='<?php esc_attr_e( 'Update Options', FLICHE_VGALLERY ); ?>'/>
                  </div> 
              </div> 
            </div> 
        <div class="clear"></div> 
