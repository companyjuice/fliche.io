...
?> 
    <div class="wrap"> 
        ...
        <?php esc_attr_e( 'Manage Video Ads', FLICHE_VGALLERY ); ?> 
                    ...
                    <thead> 
                        <tr> 
                            ...
                            <th scope="col" class="manage-column column-id sortable desc" style=""><a href="<?php echo $AdsIdURL; ?>"> 
                                <span><?php esc_attr_e( 'Ad ID', FLICHE_VGALLERY ); ?></span><span class="sorting-indicator"></span> </a></th>
                            ...
                            <th class="manage-column column-path sortable desc" scope="col" style="">
                                  ...
                                  <span><?php esc_attr_e( 'Path', FLICHE_VGALLERY ); ?></span> <span class="sorting-indicator"></span> </a></th>
                            <?php /** Display video ads type column */ ?> 
                            <th scope="col" style="" class="manage-column column-type sortable desc"><a><span><?php esc_attr_e( 'Ad Type', FLICHE_VGALLERY ); ?></span></a> </th> 
                            <?php /** Display video ads method column */ ?>
                            <th scope="col" class="manage-column column-admethod sortable desc" style=""><a><span><?php esc_attr_e( 'Ad Method', FLICHE_VGALLERY ); ?></span></a> </th>
...
?> </td> 
                  ...
                  <tfoot> <tr> <th scope="col" class="manage-column column-cb check-column" style=""><input type="checkbox" name="" id="manage-column-video-1"></th>
                          ...
                          <th scope="col" class="manage-column column-adtype sortable desc" style=""><a><span><?php esc_attr_e( 'Ad Type', FLICHE_VGALLERY ); ?></span></a> </th>
