...
<?php esc_attr_e( 'Update Video Ad', FLICHE_VGALLERY ); ?></h2> 
<?php } else {
?> <h2  class="option_title"><?php echo '<img src="' . getImagesDirURL() .'vid_ad.png" alt="move" width="30"/>'; ?>
<?php esc_attr_e( 'Add new Video Ad', FLICHE_VGALLERY ); ?></h2> 
<?php } ?>
			...
			<div class="stuffbox videoform">
				...
				<table class="form-table videoadmethod">
					<tr id="videoadmethod" name="videoadmethod">
						<td  width="150"><?php esc_attr_e( 'Select file type', FLICHE_VGALLERY ) ?></td>
						<td>
...
<?php /** Display upload video ad form */ ?>
					<table class="form-table videoadmethod">
						<tr id="ffmpeg_disable_new1" name="ffmpeg_disable_new1">
							<td  width="150"><?php esc_attr_e( 'Upload Video', FLICHE_VGALLERY ) ?></td>
							<td>
								<div id="f1-upload-form" >
									<form name="normalvideoform" method="post" enctype="multipart/form-data" >
										...
										<input type="button" class="button" name="uploadBtn" value="<?php esc_attr_e( 'Upload Video', FLICHE_VGALLERY ) ?>" disabled="disabled" onclick="return addQueue( this.form.name, this.form.myfile.value );" />
...
if ( isset( $videoadEdit->file_path ) && $uploaded_video == 1 ) {
	...
	echo  $file_path; ?>
									...
									<b><?php esc_attr_e( 'Supported video formats:', FLICHE_VGALLERY ) ?></b>
									<?php esc_attr_e( '(  MP4, M4V, M4A, MOV, Mp4v or F4V )', FLICHE_VGALLERY ) ?>
								</div>
								...
								<div id="f1-upload-progress" style="display:none">
									...
									<div class="fliche_add_new_video_ad"> <span id="f1-upload-cancel">
				...
				<form action="" name="videoadsform" class="videoform" method="post" enctype="multipart/form-data"  >
					<div id="videoadurl" style="display: none;" >
						<table class="form-table form-videoad-table">
							<tr>
								<td scope="row"  width="150" class="videoaddurl"><?php esc_attr_e( 'Video Ad URL', FLICHE_VGALLERY ) ?></td>
								<td> 
                                ...
                                if ( isset( $videoadEdit->file_path ) ) {
									...
									<?php esc_attr_e( 'Here you need to enter the video ad URL', FLICHE_VGALLERY ) ?>
									<br /><?php esc_attr_e( 'It accept also a Youtube link : http://www.youtube.com/watch?v=tTGHCRUdlBs', FLICHE_VGALLERY ) ?>
									</div>
					...
					<table id="videoimaaddetails" style="display: none;" class="form-table">
						<tr>
							<td scope="row"  width="150"><?php esc_attr_e( 'IMA Ad Type', FLICHE_VGALLERY ) ?></td>
						...
						<tr id="adimapath" style="display: none;">
							<td scope="row"  width="150"><?php esc_attr_e( 'IMA Ad Path', FLICHE_VGALLERY ) ?></td>
						...
						<tr id="adimawidth" style="display: none;">
							<td scope="row"  width="150"><?php esc_attr_e( 'Ad Slot Width', FLICHE_VGALLERY ) ?></td>
						...
						<tr id="adimaheight" style="display: none;">
							<td width="150" scope="row"><?php esc_attr_e( 'Ad Slot Height', FLICHE_VGALLERY ) ?></td>
	...
	$imaadheight = '';
						...
						<tr id="adimapublisher" style="display: none;">
							<td scope="row"  width="150"><?php esc_attr_e( 'Publisher ID', FLICHE_VGALLERY ) ?></td>
						...
						<tr id="adimacontentid" style="display: none;">
							<td scope="row"  width="150"><?php esc_attr_e( 'Content ID', FLICHE_VGALLERY ) ?></td>
						...
						<tr id="adimachannels" style="display: none;">
							<td width="150" scope="row"><?php esc_attr_e( 'Channels', FLICHE_VGALLERY ) ?></td>
					...
					<table id="videoaddetails" style="display: none;" class="form-table">
						<tr id="adtitle"  style="display: none;">
							<td scope="row"  width="150"><?php esc_attr_e( 'Title / Name', FLICHE_VGALLERY ) ?></td>
							<td>
						...
						<tr id="addescription"  style="display: none;">
							<td scope="row"  width="150"><?php esc_attr_e( 'Description', FLICHE_VGALLERY ) ?></td>
							<td>
...
if ( isset( $videoadEdit->description ) ) {
	...
	$description = '';
						...
						<tr id="adtargeturl"  style="display: none;">
							<td scope="row"  width="150"><?php esc_attr_e( 'Target URL', FLICHE_VGALLERY ) ?></td>
							<td>
...
/** Display publish  option starts */ ?>
					<table class="form-table add_video_publish">
						<tr>
							<td scope="row" width="150"><?php esc_attr_e( 'Publish', FLICHE_VGALLERY ) ?></td>
							<?php $checked = ''; 
...
<?php if ( $videoadId  ) { ?>
						<input type="submit" name="videoadsadd" class="button-primary" onclick="return validateadInput();"  value="<?php esc_attr_e( 'Update', FLICHE_VGALLERY ); ?>" class="button" /> 
						<?php } else { ?> 
						<input type="submit" name="videoadsadd" class="button-primary" onclick="return validateadInput();" value="<?php esc_attr_e( 'Save', FLICHE_VGALLERY ); ?>" class="button" /> 
						<?php } ?>
