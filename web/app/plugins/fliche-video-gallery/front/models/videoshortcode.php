...
/** Checks the FlicheShortcode class has been defined if starts */
if ( !class_exists ( 'FlicheShortcode' ) ) {
    /**
     * FlicheShortcode class starts
     * 
     * @author user
     */ 
    class FlicheShortcode { 
        /**
         * FlicheShortcode constructor starts
         */
    ...
    /** FlicheShortcode model class ends */
    }
/** Checking flicheShortcode model class if ends */
}
