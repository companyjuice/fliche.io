...
/** Checks the FlicheVideo class has been defined if starts */
if ( !class_exists ( 'FlicheVideo' ) ) {
  /**
   * FlicheVideo class starts
   * 
   * @author user
   */ 
  class FlicheVideo {
    /**
     * FlicheVideo constructor  is used to initalize
     */  
...
/** Checking FlicheVideo exist if ends */
} 
