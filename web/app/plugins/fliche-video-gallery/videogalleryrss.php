...
/** Create object for FlicheVideoController class */
$flicheOBJ  = new FlicheVideoController ();
...
switch ($type) {
    case 'recent' :
      ...
      $TypeOFvideos   = $flicheOBJ->home_thumbdata ( $thumImageorder, $where, $dataLimit );
      break;  
    case 'featured' :
    ...
    case 'category' :
      ...
      $TypeOFvideos   = $flicheOBJ->home_catthumbdata ( $where, $dataLimit );
      break;
    case 'video' :
      ...
      $TypeOFvideos = $flicheOBJ->home_thumbdata ( $thumbImageorder, $where, $dataLimit );
      break;
    case 'popular' :
    default :
