...
function createTables ($wfound, $pfound, $mfound, $tags ) {
  ...
  if (! $tags) {
    $sqlTags = 'CREATE TABLE IF NOT EXISTS ' . WVG_TAGS . ' 
      ( 
...
function createADsTable($rollfound, $adsense) {
  ...
  if (! $rollfound) {
    $sqlRoll = 'CREATE TABLE IF NOT EXISTS ' . WVG_VGADS . ' 
      ( 
  ...
  if (! $adsense) {
    $sqladsense = 'CREATE TABLE IF NOT EXISTS ' . WVG_VGOOGLEADSENSE . ' 
      ( 
...
function createVGPluginPages() {
  ...
  if (empty ( $postM )) {
    $fliche_more  = 'INSERT INTO ' . WVG_POSTS . '
      ( 
        `post_author`, 
        `post_date`, 
        `post_date_gmt`, 
  ...
  if (empty ( $postH )) {
    $fliche_home  = 'INSERT INTO ' . WVG_POSTS . '
      ( 
        `post_author`, 
        `post_date`, 
        `post_date_gmt`, 
...
function insertSampleVideos() {
  ...
  if (empty ( $videoCategories )) {
    ...
    $wpdb->query ( 'INSERT INTO ' . HDFLVVIDEOSHARE . ' 
      ( 
        `member_id`, 
        `slug`, 
        `name`, 
      ...
      ( 
        ...
        1, 
        "2:38", 
        "http://i3.ytimg.com/vi/Ef6vQBGqLW8/mqdefault.jpg", 
        "http://i3.ytimg.com/vi/Ef6vQBGqLW8/maxresdefault.jpg", 
        "", 
        "http://www.youtube.com/watch?v=Ef6vQBGqLW8", 
        "1", 
        1, 
      ...
      ( 
        ' . $member_id . ',
        ' . $postid [1] . ',
        "GI JOE 2 Retaliation Trailer 2 - 2013 Movie - Official [HD]",
        "G I Joe Retaliation Trailer 2 - 2013 movie - official movie trailer in HD - sequel of the 2009 \'s GI Joe film - starring Channing Tatum,
        Adrianne Palicki,
        Dwayne Johnson,
        Bruce Willis - directed by Jon Chu.",
        "",
        ...
        1,
        "2:31",
        "http://i3.ytimg.com/vi/mKNpy-tGwxE/mqdefault.jpg",
        "http://i3.ytimg.com/vi/mKNpy-tGwxE/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=mKNpy-tGwxE",
        "1",
        2,
      ...
      ( 
        ...
        so many religions,
        scientists,
        and governments.  2012 is an epic adventure about a global cataclysm that brings an end to the world and tells of the heroic struggle of the survivo",
        "",
        ...
        1,
        "2:22",
        "http://i3.ytimg.com/vi/rvI66Xaj9-o/mqdefault.jpg",
        "http://i3.ytimg.com/vi/rvI66Xaj9-o/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=rvI66Xaj9-o",
        "1",
        1,
      ...
      ( 
        ...
        ' . $postid [3] . ',
        "Iron Man - Trailer [HD]",
        "Paramount Pictures and Marvel Studios\' big screen adaptation of Marvel\'s legendary Super Hero Iron Man will launch into theaters on May 2, 2008. Oscar nominee Robert Downey Jr. stars as Tony Stark/Iron Man in the story of a billionaire industrialist.",
        "",
        ...
        1,
        "2:30",
        "http://i3.ytimg.com/vi/8hYlB38asDY/mqdefault.jpg",
        "http://i3.ytimg.com/vi/8hYlB38asDY/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=8hYlB38asDY",
        "1",
        1,
      ...
      ( 
        ...
        "The Avengers Trailer 2012 - Official movie teaser trailer in HD - starring Robert Downey Jr., Chris Evans, Mark Ruffalo, Chris Hemsworth, Scarlett Johansson. Joss Whedon brings together the ultimate team of superheroes in the first official trailer for",
        "",
        ...
        1,
        "1:47",
        "http://i3.ytimg.com/vi/orfMJJEd0wk/mqdefault.jpg",
        "http://i3.ytimg.com/vi/orfMJJEd0wk/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=orfMJJEd0wk",
        "1",
        1,
      ...
      ( 
        ...
        "",
        "http://www.youtube.com/watch?v=yfX1S-ifI3E",
        "", 
        "", 
        "", 
        "", 
        ...
        1,
        "2:31",
        "http://i3.ytimg.com/vi/yfX1S-ifI3E/mqdefault.jpg",
        "http://i3.ytimg.com/vi/yfX1S-ifI3E/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=yfX1S-ifI3E",
        "1",
        1,
      ...
      ( 
        ' . $member_id . ',
        ' . $postid [6] . ',
        "The Hobbit: The Desolation of Smaug International Trailer ( 2013 ) - Lord of the Rings Movie HD",
        "",
        "",
        ...
        1,
        "1:57",
        "http://i3.ytimg.com/vi/TeGb5XGk2U0/mqdefault.jpg",
        "http://i3.ytimg.com/vi/TeGb5XGk2U0/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=TeGb5XGk2U0",
        "1",
        4,
      ...
      ( 
        ' . $member_id . ',
        ' . $postid [7] . ',
        "Pirates of the Caribbean: On Stranger Tides Trailer HD",
        "",
        "",
        ...
        1,
        "2:29",
        "http://i3.ytimg.com/vi/egoQRNKeYxw/mqdefault.jpg",
        "http://i3.ytimg.com/vi/egoQRNKeYxw/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=egoQRNKeYxw",
        "1",
        3,
      ...
      ( 
        ' . $member_id . ',
        ' . $postid [8] . ',
        "Fast & Furious 6 - Official Trailer [HD]",
        "Since Dom ( Diesel ) and Brians ( Walker ) Rio heist toppled a kingpins empire and left their crew with $100 million,
        our heroes have scattered across the globe. But their inability to return home and living forever on the lam have left their lives incomplete",
        "",
        ...
        1,
        "2:35",
        "http://i3.ytimg.com/vi/PP7pH4pqC5A/mqdefault.jpg",
        "http://i3.ytimg.com/vi/PP7pH4pqC5A/maxresdefault.jpg",
        "0",
        "http://www.youtube.com/watch?v=PP7pH4pqC5A",
        "1",
        2,
      ...
      ( 
        ...
        "En el video se muestra el audio 7.1 de Samsung en sus equipos Blu-Ray como el HT-BD2 y el BD-P3600,
        este ultimo con salida de 8 canales discretos",
        "",
        ...
        1,
        "1:40",
        "http://i3.ytimg.com/vi/UJ1MOWg15Ec/mqdefault.jpg",
        "http://i3.ytimg.com/vi/UJ1MOWg15Ec/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=UJ1MOWg15Ec",
        "1",
        3,
      ...
      ( 
        ...
        "White House Down Trailer #2 2013 - Official movie trailer 2 in HD - starring Channing Tatum,
        Jamie Foxx,
        Maggie Gyllenhaal - directed by Roland Emmerich - a Washington,
        D.C. police officer is on a tour of the presidential mansion when a heavily armed group...",
        "",
        "http://www.youtube.com/watch?v=Kkoor7Z6aeE",
        "", 
        "", 
        "", 
        "", 
        ...
        1,
        "2:35",
        "http://i3.ytimg.com/vi/Kkoor7Z6aeE/mqdefault.jpg",
        "http://i3.ytimg.com/vi/Kkoor7Z6aeE/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=Kkoor7Z6aeE",
        "1",
        3,
      ...
      ( 
        ...
        "",
        "",
        "http://www.youtube.com/watch?v=DaYx4XmWEoI",
        "", 
        "", 
        "", 
        "", 
        ...
        1,
        "3:31",
        "http://i3.ytimg.com/vi/DaYx4XmWEoI/mqdefault.jpg",
        "http://i3.ytimg.com/vi/DaYx4XmWEoI/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=DaYx4XmWEoI",
        "1",
        1,
      ...
      ( 
        ...
        "Watch the Exclusive Official Theatrical Trailer of Krrish 3,
        the most awaited movie of the year starring Hrithik Roshan,
        Priyanka Chopra,
        Kangna Ranaut,
        Vivek Oberoi & Shaurya Chauhan. Releasing this Diwali...! Directed & Produced by - Rakesh Roshan",
        "",
        ...
        1,
        "2:16",
        "http://i3.ytimg.com/vi/MCCVVgtI5xU/mqdefault.jpg",
        "http://i3.ytimg.com/vi/MCCVVgtI5xU/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=MCCVVgtI5xU",
        "1",
        2,
      ...
      ( 
        ...
        1,
        "0:32",
        "http://i3.ytimg.com/vi/ey0aA3YY0Mo/mqdefault.jpg",
        "http://i3.ytimg.com/vi/ey0aA3YY0Mo/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=ey0aA3YY0Mo",
        "1",
        3,
      ...
      ( 
        ' . $member_id . ',
        ' . $postid [14] . ',
        "Journey To The Center Of The Earth HD Trailer",
        "",
        "",
        "http://www.youtube.com/watch?v=iJkspWwwZLM",
        "", 
        "", 
        "", 
        "", 
        ...
        1,
        "2:30",
        "http://i3.ytimg.com/vi/iJkspWwwZLM/mqdefault.jpg",
        "http://i3.ytimg.com/vi/iJkspWwwZLM/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=iJkspWwwZLM",
        "1",
        2,
      ...
      ( 
        ...
        "",
        "http://www.youtube.com/watch?v=ja-qjGeDBZQ",
        "", 
        "", 
        "", 
        "", 
        ...
        1,
        "2:33",
        "http://i3.ytimg.com/vi/ja-qjGeDBZQ/mqdefault.jpg",
        "http://i3.ytimg.com/vi/ja-qjGeDBZQ/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=ja-qjGeDBZQ",
        "1",
        3,
      ...
      ( 
        ...
        1,
        "1:47",
        "http://i3.ytimg.com/vi/Vpg9yizPP_g/mqdefault.jpg",
        "http://i3.ytimg.com/vi/Vpg9yizPP_g/maxresdefault.jpg",
        "",
        "http://www.youtube.com/watch?v=Vpg9yizPP_g",
        "1",
        3,
    ...
    for($i = 1; $i <= 17; $i ++) {
      ...
      $wpdb->query ( 'INSERT INTO ' . WVG_POSTS . ' 
        ( 
          `post_author`,
          `post_date`, 
          `post_date_gmt`, 
...
function insertSampleCategories () {
  ...
  if (empty ( $movieTrailer )) {  
    $wpdb->query ( 'INSERT INTO ' . WVG_PLAYLIST . '
      ( 
        `pid`, `playlist_name`,`playlist_slugname`, `playlist_desc`, `playlist_thumb`, `playlist_image`, `playlist_order`, `is_publish` 
      )
      VALUES
  ...
  if (empty ( $media2Play )) {
    $wpdb->query ( 'INSERT INTO ' . WVG_MED2PLAY . ' 
      ( 
        `rel_id`, `media_id`, `playlist_id`, `porder`, `sorder` 
      )
      VALUES
        ( 6, 27, 3, 0, 0 ), 
        ( 7, 1, 2, 0, 0 ), 
...
function insertSettingsTable () {
  ...
  if (empty ( $videoSettings )) {
    $wpdb->query ( 'INSERT INTO ' . WVG_SETTINGS . '
      ( 
        `default_player`,
        `settings_id`, 
        `autoplay`, 
      ...
      ( 
        ...
        0,
        "0",
        "wp-content/uploads/videogallery", 
        "", 
        "", 
        " ", 
        "0", 
    ...
    $player_color_data = array ( 
      'sharepanel_up_BgColor' => '', 
      'sharepanel_down_BgColor' => '', 
      'sharepaneltextColor' => '', 
      'sendButtonColor' => '', 
      'sendButtonTextColor' => '', 
      'textColor' => '', 
      ...
      'report_visible' => '', 
      'amazon_bucket_access_secretkey' => '', 
      'amazon_bucket_access_key' => '', 
      'amazonbuckets_link' => '', 
      'amazonbuckets_name' => '', 
      'amazonbuckets_enable' => '', 
      'iframe_visible' => '', 
      'googleadsense_visible' => '', 
      'user_allowed_method' => 'y', 
      'show_added_on' => '1', 
      'member_upload_enable' => '1', 
      'show_rss_icon' => '1' 
    );
...
function upgrade_videos() {
  ...
  if (empty ( $slugID )) {
      ...
      /** Loop thru video details in video table */
