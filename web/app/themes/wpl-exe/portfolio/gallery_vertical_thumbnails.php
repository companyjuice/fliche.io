	...
	<div class="container">
		<div class="row">
			<div class="col-md-1 col-sm-1 hidden-xs">
				<div id="single-portfolio-thumbs-vertical" style="display: none">
					<?php $x=0; foreach( $portfolio as $img ): ?>
					<a data-slide-index="<?php echo esc_attr( $x ); ?>" href="javascript:;"><?php echo wpl_exe_image( $img, 90, 60 ); ?></a>
					<?php $x++; endforeach; ?>
				</div>
			</div>
			<div class="col-md-8 col-sm-11 col-xs-12">
				...
				<?php if( is_array( $portfolio ) && count( $portfolio ) > 0 ): ?>
					<div id="wproto-portfolio-primary-slider" class="single-portfolio-slider">
...
<div class="portfolio-related-posts">
	<div class="container">
		<div class="row">
			...
			-->
			<?php wpl_exe_wp_front::portfolio_related_posts( get_the_ID(), 'style_3' ); ?>
			</div>
		</div>
	</div>
</div>
