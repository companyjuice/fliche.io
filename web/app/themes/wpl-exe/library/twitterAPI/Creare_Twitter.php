...
class Creare_Twitter
{
 	...
 	public function getLatestTweets()
	{
		...
		$latesttweets = $twitterconn->get("https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=".$this->screen_name."&count=".$this->not."&exclude_replies=true");		
