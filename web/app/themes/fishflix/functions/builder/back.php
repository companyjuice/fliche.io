...
if( ! function_exists( 'mfn_builder_section' ) )
{
	...
	function mfn_builder_section( $section = false, $section_id = false, &$wrap_id = false ) {
		...
		echo '<div class="mfn-element mfn-row" data-title="'. __('Section','mfn-opts') .'">';
...
if( ! function_exists( 'mfn_builder_wrap' ) )
{
	...
	function mfn_builder_wrap( $wrap = false, $wrap_id = false, $parent_id = false ) {
		...
		$sizes 			= array( '1/6' => 0.1666, '1/5' => 0.2, '1/4' => 0.25, '1/3' => 0.3333, '1/2' => 0.5, '2/3' => 0.6667, '3/4' => 0.75, '1/1' => 1, 'divider' => 1 );
		...
		echo '<div class="mfn-element mfn-wrap '. $class .'" data-size="'. $sizes[$size] .'">';
			...
			echo '<div class="mfn-element-content">';
				...
				echo '<div class="mfn-element-header mfn-wrap-header">';
					...
					echo '<div class="mfn-element-tools">';
						echo '<a class="mfn-element-btn mfn-element-clone mfn-wrap-clone" title="'. __('Clone','mfn-opts') .'" href="javascript:void(0);">C</a>';
						echo '<a class="mfn-element-btn mfn-element-delete" title="'. __('Delete','mfn-opts') .'" href="javascript:void(0);">D</a>';
					echo '</div>';
...
if( ! function_exists( 'mfn_builder_item' ) )
{
	...
	function mfn_builder_item( $item_type, $item = false, $parent_id = false ) {
		...
		$sizes 				= array( '1/6' => 0.1666, '1/5' => 0.2, '1/4' => 0.25, '1/3' => 0.3333, '1/2' => 0.5, '2/3' => 0.6667, '3/4' => 0.75, '1/1' => 1 );
				...
				<div class="mfn-row-add">
					<table class="form-table">
						<tbody>
							<tr valign="top">
								<td>
									<a class="mfn-row-add-btn" href="javascript:void(0);"><em></em><?php _e('Add Section','mfn-opts'); ?></a>
					...
					<div class="mfn-popup-inside">
						...
						<div class="mfn-popup-header">
							...
							<div class="mfn-ph-right">			
								<a class="mfn-ph-btn mfn-ph-close" title="<?php _e( 'Close', 'mfn-opts' ); ?>" href="javascript:void(0);">C</a>
							</div>
