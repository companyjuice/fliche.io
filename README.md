...
1. Clone the git repo - `git clone https://github.com/companyjuice/fliche.io.git`
...
3. Copy `.env.example` to `.env` and update environment variables:
  ...
  * `WP_HOME` - Full URL to WordPress home (http://fliche.com)
  * `WP_SITEURL` - Full URL to WordPress including subdirectory (http://fliche.com/wp)
...
6. Access WP admin at `http://fliche.com/wp/wp-admin`
